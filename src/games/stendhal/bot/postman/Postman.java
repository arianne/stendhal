...
public class Postman implements Runnable {
					...
					if (!object.get("name").equals("postman")) {
						...
						if (cmd.equalsIgnoreCase("hi")) {
							...
							chat("Bye.");
						        ...
						        || cmd.equalsIgnoreCase("job") || cmd.equalsIgnoreCase("offer")
						        || cmd.equalsIgnoreCase("letter") || cmd.equalsIgnoreCase("parcel")) {
	...
	private void onWhoResponse(StringTokenizer st) {
		...
		// Save to disk
		try {
			messages.storeToXML(new FileOutputStream(System.getProperty("user.home") + "/.stendhal-postman.xml"),

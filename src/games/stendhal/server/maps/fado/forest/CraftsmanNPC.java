...
/**
 * Builds an albino elf NPC He is a trader and takes part in a quest
 * (maps/quests/ElvishArmor.java)
 * 
 * @author kymara
 */
	...
	private void buildNPC(StendhalRPZone zone) {
		SpeakerNPC npc = new SpeakerNPC("Lupos") {
			...
			protected void createDialog() {
				// addGreeting("Welcome to this forest, south of Or'ril
				// river.");

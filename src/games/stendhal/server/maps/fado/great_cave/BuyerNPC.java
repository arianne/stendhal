...
public class BuyerNPC implements ZoneConfigurator {
	...
	private void buildNPC(StendhalRPZone zone) {
		SpeakerNPC npc = new SpeakerNPC("Vonda") {
			...
			protected void createDialog() {
				...
				addHelp("I could tell you about some of these wonderful items here. The white #pot, #coffins, #dress, #shield, #armor, #tools, #rug, #flowers and #clock are all fascinating!");
				addReply("pot","Ahh, the oriental pot! That is an original from the oni palace, you know.");
				...
				addReply("rug","That is a genuine rug from the far East. I have never seen one like it, only cheap copies.");
				...
				addReply("tools","Those tools on the back wall are a true antique! They were used by the great grandfather of Xoderos, isn't that incredible!");

	...
	private void buildNPC(StendhalRPZone zone, Map<String, String> attributes) {
		SpeakerNPC npc = new SpeakerNPC("Jef") {
			...
			protected void createDialog() {
				...
				addReply(
						"news",
						"Some shopkeepers will be at the market soon! It'll be cool, it's kind of empty round here at the moment.");
				addReply("shops",
						"Yeah she's had to go out of town. But there's #news about our own bazaar.");

	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Ortiv Milquetoast") {
			...
			protected void createDialog() {
				...
				addQuest("I want to prepare a mixture for keeping the assassins and bandits in my cellar. I could need some ingredients for that soon...");
				addGoodbye("Take care of you and please return soon to visit me again, I'm scared alone!");

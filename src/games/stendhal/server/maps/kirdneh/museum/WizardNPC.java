	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Kampusch") {
			...
			@Override
				...
				addReply("fabric","Cloth has different standards, which I'm sure you'll notice in your own cloaks. #Mithril fabric is the very finest and strongest of all. But then, I would say that, being from Mithrilbourgh...");
				addReply("mithril","Should you need it, I can #fuse mithril nuggets and silk thread together. But I don't perform this magic for just anyone...");
				addGoodbye("Farewell.");

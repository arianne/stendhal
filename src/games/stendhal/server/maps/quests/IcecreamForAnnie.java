		...
		npc = new SpeakerNPC("Annie Jones") {
			...
			protected void createDialog() {
							...
							public void fire(Player player, Sentence sentence,
								...
								if (!player.hasQuest(QUEST_SLOT)
									...
									npc.say("I'm full up now thank you!");
										...
										"eating;")) {
									// She is still full from her previous
									// icecream,
									// she doesn't want another yet
									String[] tokens = player.getQuest(
											QUEST_SLOT).split(";"); // this
									// splits
									// the time
									// from the
									// word
									// eating
									// tokens now is like an array with 'eating'
									// in
									// tokens[0] and
									...
									// ->
									// milliseconds
									// timeRemaining is ''time when quest was
									// done +
									// delay - time now''
									...
									if (timeRemaining > 0L) {
										...
										return;
										// note: it is also possible to make the
										// npc
										// say an approx time but this sounded
										// wrong
										// with the 'at least'
									}
									// She has recovered and is ready for
									// another
				...
				add(ConversationStates.QUEST_OFFERED,
						...
						new SetQuestAndModifyKarmaAction(QUEST_SLOT, "start",
								10.0));
				...
				add(ConversationStates.QUEST_OFFERED,
						...
						new SetQuestAndModifyKarmaAction(QUEST_SLOT,
								"rejected", -5.0));

...
public class PizzaDelivery extends AbstractQuest {
	...
	private static class CustomerData {
		...
		/**
		 * The text that the customer should say upon quick delivery.
		 * It should contain %d as a placeholder for the tip, and
		 * can optionally contain %s as a placeholder for the pizza flavor.  
		 */
		...
		private CustomerData(String npcDescription, String flavor, int expectedTime, int tip, int xp,
		        String messageHot, String messageCold) {
	...
	private void buildCustomerDatabase() {
		...
		customerDB
		        .put(
		                ...
		                new CustomerData(
		                        ...
		                        "Pizza Prosciutto",
		                        7, // minutes to deliver. Tested by mort: 6:30 min, with killing some orcs.
		                        200, // tip when delivered on time. Quite high because you can't do much senseful on top of the hill and must walk down again.
		...
		customerDB
		        .put(
		                ...
		                new CustomerData(
		                        ...
		                        "Pizza del Mare",
		                        7, // minutes to deliver. Tested by mort: 6 min, ignoring slow animals and not walking through the swamps.
		...
		customerDB.put("Fidorea", new CustomerData("Fidorea lives in Ados city. She is a makeup artist.",
		        "Pizza Napoli",
		        7, // minutes to deliver. Tested by mort: about 6 min, outrunning all enemies.
		...
		customerDB.put("Haizen", new CustomerData("Haizen is a magician who lives in a hut near the road to Ados.",
		        "Pizza Diavolo",
		        4, // minutes to deliver. Tested by kymara: exactly 3 min.
		...
		customerDB
		        .put(
		                "Jenny",
		                new CustomerData("Jenny owns a mill near Semos.", "Pizza Margherita",
		                        2, // minutes to deliver. Tested by mort: can be done in 1:15 min, with no real danger.
		...
		customerDB
		        .put(
		                ...
		                new CustomerData(
		                        ...
		                        "Pizza Funghi",
		                        6, // minutes to deliver. Tested by mort: 5:30 min, leaving the slow monsters on the way behind.
		...
		customerDB.put("Katinka", new CustomerData("Katinka takes care of the animals at the Ados Wildlife Refuge.",
		        "Pizza Vegetale",
		        4, // minutes to deliver. Tested by kymara in 3:25 min, leaving behind the orcs.
		...
		customerDB.put("Marcus", new CustomerData("Marcus is a guard in the Semos jail.", "Pizza Tonno", 2, // minutes to deliver. Tested by mort: can be done in 90 sec with no danger.
		        25, // tip when delivered on time. A bit higher than Jenny because you can't do anything else in the jail and need to walk out again.
		        10, // experience gain for delivery
		        "Ah, my %s! Here's your tip: %d pieces of gold.", "Finally! Why did that take so long?"));

		customerDB.put("Nishiya", new CustomerData("Nishiya sells sheep. You'll find him west of here.",
		        "Pizza Pasta",
		...
		customerDB.put("Ouchit", new CustomerData(
		        ...
		        1, // minutes to deliver. Tested by mort: can be done in 45 sec with no danger.
		        10, // tip when delivered on time
		        5, // experience gain for delivery
		...
		customerDB.put("Tor'Koom", new CustomerData(
		        ...
		        9, // minutes to deliver. Tested by kymara: done in about 8 min, with lots of monsters getting in your way.
		        170, // tip when delivered on time
		        30, // experience gain for delivery
		        "Yummy %s! Here, take %d moneys!", "Grrr. Pizza cold. You walking slow like sheep."));
	}
	...
	private void startDelivery(Player player, SpeakerNPC npc) {
		...
		npc.say("You must bring this " + data.flavor + " to #" + name + " within "
		        + Grammar.quantityplnoun(data.expectedMinutes, "minute") + ". Say \"pizza\" so that " + name
	...
	private void prepareBaker() {
		...
		leander.add(ConversationStates.ATTENDING, ConversationPhrases.QUEST_MESSAGES, null,
			        ...
			        public void fire(Player player, String text, SpeakerNPC npc) {
				        if (player.hasQuest(QUEST_SLOT)) {
					        ...
					        if (isDeliveryTooLate(player)) {
						        ...
						        npc.say("I see you failed to deliver the pizza to " + customerName
					        ...
					        npc
					                .say("I need you to quickly deliver a hot pizza. If you're fast enough, you might get quite a nice tip. So, will you do it?");
				        }
			        }
		        });

		leander.add(ConversationStates.QUEST_OFFERED, ConversationPhrases.YES_MESSAGES, null,
		...
		leander.add(ConversationStates.QUEST_OFFERED, "no", null, ConversationStates.ATTENDING,
	...
	private void prepareCustomers() {
		...
		for (String name : customerDB.keySet()) {
			...
			npc.add(ConversationStates.ATTENDING, "pizza", null, ConversationStates.ATTENDING, null,
			        new SpeakerNPC.ChatAction() {

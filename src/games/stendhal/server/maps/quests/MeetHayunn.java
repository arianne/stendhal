...
public class MeetHayunn extends AbstractQuest {
	...
	private void prepareHayunn() {
		...
		npc.add(ConversationStates.INFORMATION_7,
				ConversationPhrases.YES_MESSAGES, new QuestCompletedCondition(
						QUEST_SLOT), ConversationStates.IDLE, epilog
						+ "You know, you remind me of my younger self...", null);
		...
		npc.add(
				...
				epilog
						+ "Well, good luck in the dungeons! Here's hoping you find fame and glory, and keep watch for monsters!",

...
public class MeetZynn extends AbstractQuest {
	...
	private void step_1() {
		 ...
		 * list is complete?
		 */
		npc.add(ConversationStates.ATTENDING, "bye", null, ConversationStates.IDLE, null, new SpeakerNPC.ChatAction() {
			...
			public void fire(Player player, String text, SpeakerNPC engine) {
				...
				if (level < 15) {
					engine
					        .say("Bye. Hey, if you're going to hang around the library, don't forget to be quiet; people could be studying!");
				} else {
					engine.say("Bye. Hey, you should consider getting a library card, you know.");
				}
			}
		});
	}

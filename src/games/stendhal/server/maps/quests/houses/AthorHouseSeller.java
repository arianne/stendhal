...
final class AthorHouseSeller extends HouseSellerNPCBase {
	...
	private void init() {
		...
		addJob("Well, I'm actually trying to sunbathe here. But, since you ask, I sell apartments here on Athor. Our brochure is at #http://stendhalgame.org/wiki/index.php/StendhalHouses.");

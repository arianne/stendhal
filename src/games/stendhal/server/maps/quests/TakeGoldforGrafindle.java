				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (player.isQuestCompleted(QUEST_SLOT)) {
							...
							engine
									.say("I need someone who can be trusted with #gold.");
						}
					}
				});
				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (player.drop("gold_bar", GOLD_AMOUNT)) {
							engine
									.say("Oh, you brought the gold! Wonderful, I knew I could rely on you. Please, have this key to our customer room.");
							...
							engine
									.say("Haven't you got the gold bars from #Lorithien yet? Please go get them, quickly!");
						}
					}
				});
	}

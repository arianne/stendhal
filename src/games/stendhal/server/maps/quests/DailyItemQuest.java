...
public class DailyItemQuest extends AbstractQuest {
	...
	class DailyQuestAction extends SpeakerNPC.ChatAction {
        ...
        private final List<String> listeditems = Arrays.asList("knife","dagger","short_sword","sword","scimitar","katana","claymore","broadsword","biting_sword","old_scythe","small_axe","hand_axe","axe","battle_axe","bardiche","scythe","twoside_axe","halberd","club","staff","mace","flail","mace_+2","skull_staff","morning_star","hammer","hammer_+3","war_hammer","wooden_bow","longbow","wooden_arrow","steel_arrow","buckler","wooden_shield","studded_shield","plate_shield","lion_shield","unicorn_shield","lion_shield_+1","skull_shield","crown_shield","dress","leather_armor","leather_cuirass","leather_armor_+1","leather_cuirass_+1","studded_armor","chain_armor","chain_armor_+1","scale_armor","chain_armor_+3","scale_armor_+2","plate_armor","leather_helmet","studded_helmet","chain_helmet","leather_legs","studded_legs","chain_legs","leather_boots", "studded_boots","cloak","elf_cloak","dwarf_cloak","elf_cloak_+2","green_dragon_cloak","cheese","carrot","salad","apple","bread","meat","ham","sandwich","pie","button_mushroom","porcini","toadstool","beer","wine","minor_potion","antidote","potion","greater_potion","poison","flask","money","arandula","wood","grain","flour","iron_ore","iron","dice","teddy","perch","roach","char","trout","surgeonfish","onion","leek","clownfish"); 

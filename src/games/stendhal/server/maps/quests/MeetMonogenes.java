...
public class MeetMonogenes extends AbstractQuest {
	...
	public void addToWorld() {
		...
		npc.add(ConversationStates.INFORMATION_1, "no", null, ConversationStates.IDLE,
		...
		npc.add(ConversationStates.INFORMATION_2, "no", null, ConversationStates.IDLE,
		        "Already finding your way about, huh? Glad to hear it! Goodbye!", null);

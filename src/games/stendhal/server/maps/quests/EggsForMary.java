 ...
 * PARTICIPANTS:
 * <ul>
 * <li> Mary, a little girl walking around looking for eggs</li>
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li> Mary asks you for eggs for her pancakes</li>
 * <li> You collect 10 eggs from the chickens</li>
 * <li> You give the eggs to Mary.</li>
 * <li> Mary gives you 10 pansys in return.<li>
 * </ul>
 *
 * REWARD:
 * <ul>
 * <li> 10 pansys or 10 daisies</li>
 * <li> 50 XP</li>
 * <li> Karma: 10</li>
 * </ul>
 *
...
public class EggsForMary extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		if (isCompleted(player)) {
			res.add("I have given Mary the eggs. She gave me some flowers in return. I also gained 50 xp");
		}
		if(isRepeatable(player)){
			res.add("Mary's mom needs more eggs again.");
		}
		return res;
	}
	...
	private void prepareBringingStep() {
		final SpeakerNPC npc = npcs.get("Mary");
		// player has eggs and tells Mary, yes, it is for her

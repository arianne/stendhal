				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (!player.isQuestCompleted("clean_storage")) {
							engine
									.say("My #basement is absolutely crawling with rats. Will you help me?");
						} else {
							engine
									.say("Thanks again! I think it's still clear down there.");
							engine
				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (player.hasKilled("rat")
							...
							engine
									.say("Don't you remember promising to clean out the rats from my #basement?");
						}
					}
				});

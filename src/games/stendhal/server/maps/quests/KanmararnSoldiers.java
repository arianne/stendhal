 ...
 *  - bring them back to Henry to get the map
...
public class KanmararnSoldiers extends AbstractQuest {
	...
	private void prepareCowardSoldier() {
		...
		henry.add(ConversationStates.IDLE,
				...
				new HenryQuestStartedCondition(),
				ConversationStates.ATTENDING,
				null,
				new HenryQuestCompleteAction());
		
		henry.add(ConversationStates.ATTENDING,
				Arrays.asList("map", "group", "help"),
		...
		henry.add(ConversationStates.ATTENDING,
				...
				ConversationStates.ATTENDING,
				"If you find my friends, i will give you the map",
				null);
	}
	...
	private void prepareCorpses() {
		...
		CorpseRefiller tomRefiller = new CorpseRefiller(tom,
				"leather_legs",
		...
		CorpseRefiller peterRefiller = new CorpseRefiller(peter,
				"scale_armor",
	...
	private void prepareSergeant() {
		...
		james.add(ConversationStates.ATTENDING,
				Arrays.asList("map", "henry", "quest", "task", "help", "group", "one"),
				new JamesQuestCompletedCondition(),
				ConversationStates.ATTENDING,
				"Thanks again for bringing me the map!",
				null);
	}

				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (player.isQuestCompleted(QUEST_SLOT)) {
							engine
									.say("My brother has enough food now, many thanks.");
						} else {
							engine
									.say("I'm worried about my brother who lives in Ados. I need someone to take some #food to him.");
						}
					}
				});
				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						if (player.drop("sandwich", FOOD_AMOUNT)) {
							...
							player.addXP(150);
							engine
									.say("Thank you! Please let Xoderos know that I am fine. Say my name, Joshua, so he knows that you saw me. He will probably give you something in return.");
							player.notifyWorldAboutChanges();
						} else {
							engine
									.say("Hey! Where did you put the sandwiches?");
						}
					}
				});
		...
		npc.add(
				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, String text,
						...
						player.addXP(50);
						engine
								.say("I'm glad Joshua is well. Now, what can I do for you? I know, I'll fix that broken key ring that you're carrying ... there, it should work now!");

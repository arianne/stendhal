...
public class ElfPrincess extends AbstractQuest {
	...
	private void offerQuestStep() {
		...
		npc.add(ConversationStates.ATTENDING,
				ConversationPhrases.QUEST_MESSAGES, new OrCondition(
						new QuestInStateCondition(QUEST_SLOT, "start"),
						new QuestInStateCondition(QUEST_SLOT, "got_flower")),
				ConversationStates.ATTENDING,
				"I do so love those pretty flowers from Rose Leigh ...", null);
	...
	private void getFlowerStep() {
		...
		rose.add(
				...
				new MultipleActions(new EquipItemAction("rhosyd", 1, true),
						new SetQuestAction(QUEST_SLOT, "got_flower")));
	...
	private void bringFlowerStep() {
		SpeakerNPC npc = npcs.get("Tywysoga");
		npc.add(ConversationStates.ATTENDING,
				Arrays.asList("flower", "Rhosyd"), new AndCondition(
						new QuestInStateCondition(QUEST_SLOT, "got_flower"),
						new PlayerHasItemWithHimCondition("rhosyd")),
				...
				new SpeakerNPC.ChatAction() {
					...
					public void fire(Player player, Sentence sentence,
						...
						npc.say("Thank you! Take these "
								+ Integer.toString(goldamount)
								+ " gold bars, I have plenty. And, listen: If you'd ever like to get me another, be sure to ask me first. Rose Leigh is superstitious, she won't give the bloom unless she senses you need it.");

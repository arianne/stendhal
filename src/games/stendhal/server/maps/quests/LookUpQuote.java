 ...
 * PARTICIPANTS:
 * - Perquod the fisherman
 *  
 *
 * STEPS:
 * - The fisherman asks you to go to the library to get him a quote
 * 	 of a famous fisherman.
 * - The player goes to the library where a book with some quotes  
 *   lies on the table and looks the correct one up.
 * - The player goes back to the fisherman and tells him the quote.
 *  
 *
 * REWARD:
 * - 750 XP
...
public class LookUpQuote extends AbstractQuest {
	...
	private void createFishingRod() {
		...
		fisherman.add(ConversationStates.QUEST_OFFERED,
				...
				null,
				ConversationStates.ATTENDING,
				"Then I don't do you a favour, either.",
				null);
		...
		fisherman.add(ConversationStates.QUESTION_1,
				...
				null,
				ConversationStates.ATTENDING,
				"Too bad. I would have had a nice reward for you.",
				null);
		
		fisherman.add(ConversationStates.QUESTION_2,
				"",
				null,
				ConversationStates.ATTENDING,
				null,

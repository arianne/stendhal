...
public class PrepareOfferHandler {
	...
	public void add(SpeakerNPC npc) {
		npc.add(ConversationStates.ATTENDING, "sell", 
				...
				"I am sorry, I currently only accepting offers from people who have a good reputation. You can obtain acceptance by gaining experience for example by helping people with their tasks or defending the city from evil creatures.", null);
		npc.add(ConversationStates.ATTENDING, "sell", 

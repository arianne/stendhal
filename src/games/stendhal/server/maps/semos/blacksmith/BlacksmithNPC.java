...
/**
 * The blacksmith (original name: Xoderos). Brother of the goldsmith in Ados. He
 * refuses to sell weapons, but he casts iron for the player, and he sells
 * tools.
 * 
 * @author daniel
 * 

...
/**
 * Configure Kanmararn Prison to include a Duergar King Creature who carries a
 * key. Then it should give a key that is bound to the player.
 */
public class DuergarKingCreature implements ZoneConfigurator {
	...
	private void buildPrisonArea(StendhalRPZone zone,
		...
		Creature creature = new ItemGuardCreature(
				manager.getCreature("duergar_king"), "kanmararn_prison_key");
		CreatureRespawnPoint point = new CreatureRespawnPoint(zone, 50, 15,
				creature, 1);
		zone.add(point);
	}
}

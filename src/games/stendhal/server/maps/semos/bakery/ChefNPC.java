...
/**
 * The bakery chef. Father of the camping girl. He makes sandwiches for players.
 * 
 * @author daniel
...
public class ChefNPC extends SpeakerNPCFactory {
	...
	public void createDialog(SpeakerNPC npc) {
		...
		npc.addReply("bread",
				"Oh, Erna handles that side of the business; just go over and talk to her.");
		npc.addReply(
				"cheese",
		...
		npc.addReply("pizza",
				"I need someone who helps me delivering pizza. Maybe you could do that #task.");
		npc.addReply(
				Arrays.asList("sandwich", "sandwiches"),

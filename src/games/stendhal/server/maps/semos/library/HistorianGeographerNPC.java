		...
		SpeakerNPC npc = new SpeakerNPC("Zynn Iwuhos") {
			...
			protected void createDialog() {
				add(ConversationStates.IDLE,
						...
						new SpeakerNPC.ChatAction() {
							...
							public void fire(Player player, Sentence sentence,
									SpeakerNPC engine) {
								// A little trick to make NPC remember if it has
								// met
								// player before anc react accordingly
								// NPC_name quest doesn't exist anywhere else
								// neither is
				...
				add(
						...
						Arrays.asList("offer", "buy", "trade", "deal",
								"scroll", "scrolls", "home", "empty", "marked",
								"summon", "magic", "wizard", "sorcerer"),
						null,
						ConversationStates.ATTENDING,

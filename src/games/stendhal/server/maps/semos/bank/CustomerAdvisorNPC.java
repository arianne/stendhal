...
public class CustomerAdvisorNPC extends SpeakerNPCFactory {
	...
	public void createDialog(SpeakerNPC npc) {
		...
		npc.addReply("security", "Yes, there is a spell to make sure noone can return to this world next to the table. If they exit to the astral plane when stood by the table, and then attempt to return there, they are magically moved to a safer place. Good luck with your trading!");

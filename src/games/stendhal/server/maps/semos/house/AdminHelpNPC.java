...
public class AdminHelpNPC extends SpeakerNPCFactory {
	...
	protected void createDialog(SpeakerNPC npc) {
		...
		npc.addJob("I'm here to make you feel happy. And you can come here easily if you #/teleportto me");
		...
		npc.addReply("things","So you're one of the people who tests every #blue #word, aren't you? Now wonder you have responsibility!");

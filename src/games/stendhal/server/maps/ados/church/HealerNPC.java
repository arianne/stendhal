...
public class HealerNPC extends SpeakerNPCFactory {
	...
	public void createDialog(SpeakerNPC npc) {
		...
		npc.addReply(
				"heal",
				"I can #concoct a strong #mega_potion for you to use while you travel. I need one special ingredient and a small charge to cover my time.");
		npc.addReply("mega_potion",
				"It is a powerful elixir. If you want one, ask me to #concoct #1 #mega_potion.");
		npc.addReply(
				"money",
				"That is your own concern. We of the cloth need not scurry around to make cash.");
		...
		ProducerBehaviour behaviour = new ProducerBehaviour(
				"Valo_concoct_potion", "concoct", "mega_potion",

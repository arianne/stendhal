	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Fritz") {
			...
			protected void createDialog() {
				...
				addReply("whole life","The feeling you have when fishies hang on your rod is awesome! Did you ever try to catch some by #yourself?");
				addReply("yourself", "You can ask my friend Santiago for help, he lives in a fisherhut somewhere in the city!");
				addQuest("Ahoy Matey! I don't have any tasks for you but others do!"); 
				addJob("I am a fisherman. For many, many years I went fishing every day. There have been dangerous storms I had to get over and some reeeeeally big fish which almost drown my ship, but of course I always was able to #catch them!");
				addReply("catch","Hehe! I hope that I will be able to deliver some fish to the market one time...");
				addOffer("My fishing places on the sea are catched by some ugly #storm I can't drive out at the moment.");
				addReply("storm", "The huge storm halfway destroyed my boat! Sorry matey, I can't offer you anything at the moment...");

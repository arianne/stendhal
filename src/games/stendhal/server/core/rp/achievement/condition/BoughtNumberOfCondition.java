...
public class BoughtNumberOfCondition implements ChatCondition {
	 ...
	 */
	public BoughtNumberOfCondition(final String itemName, final int count) {
	 ...
	 * 		Names of the items.
	 */
	public BoughtNumberOfCondition(final int count, final String... itemName) {
		itemList = new HashMap<>();
	 ...
	 * 		List of item names.
	 */
	public BoughtNumberOfCondition(final int count, final List<String> items) {
		itemList = new HashMap<>();
	 ...
	 */
	public BoughtNumberOfCondition(final Map<String, Integer> items) {
		itemList = items;
	}
	...
	public boolean fire(Player player, Sentence sentence, Entity npc) {
		for (final String item: itemList.keySet()) {
			...
			final int actual = player.getQuantityOfBoughtItems(item);
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("BoughtNumberOf [");
	...
	public boolean equals(final Object obj) {
		if (!(obj instanceof BoughtNumberOfCondition)) {
			return false;
		}

		final BoughtNumberOfCondition other = (BoughtNumberOfCondition) obj;

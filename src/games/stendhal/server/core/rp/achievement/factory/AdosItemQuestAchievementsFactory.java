...
public class AdosItemQuestAchievementsFactory extends AbstractAchievementFactory {
	...
	public Collection<Achievement> createAchievements() {
		...
		achievements.add(createAchievement("quest.special.daily_item.0010", "Ados's Supporter", "Finish daily item quest 10 times",
												Achievement.EASY_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 9)));
		achievements.add(createAchievement("quest.special.daily_item.0050", "Ados's Provider", "Finish daily item quest 50 times",
												Achievement.EASY_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 49)));
		achievements.add(createAchievement("quest.special.daily_item.0100", "Ados's Supplier", "Finish daily item quest 100 times",
												Achievement.MEDIUM_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 99)));
		achievements.add(createAchievement("quest.special.daily_item.0250", "Ados's Stockpiler", "Finish daily item quest 250 times",
												Achievement.MEDIUM_BASE_SCORE, true, new QuestStateGreaterThanCondition("daily_item", 2, 249)));
		achievements.add(createAchievement("quest.special.daily_item.0500", "Ados's Hoarder", "Finish daily item quest 500 times",

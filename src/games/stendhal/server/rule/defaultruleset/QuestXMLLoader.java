...
public class QuestXMLLoader extends DefaultHandler {

	/** The Singleton instance. */
	private static QuestXMLLoader instance;

	/** the logger instance. */
	private static final Logger logger = Log4J.getLogger(QuestXMLLoader.class);
	...
	public static void main(String argv[]) {
		...
		try {
			System.out.println(new QuestXMLLoader().load(argv[0]).size());
		} catch (Throwable e) {
			e.printStackTrace();
		}
		System.exit(0);
	...
	private QuestXMLLoader() {
		// hide constructor, this is a Singleton
	}

	public static QuestXMLLoader get() {
		if (instance == null) {
			instance = new QuestXMLLoader();
			try {

...
public class Stocking extends Box implements UseListener {
	...
	// TODO: Make these configurable
        ...
        private static final String[] ITEMS = { "mega_potion", "fish_pie", "lucky_charm", "diamond", "gold_bar",
                "empty_scroll" };
	 ...
	 * @param attributes
	 */
	public Stocking(String name, String clazz, String subclass, Map<String, String> attributes) {

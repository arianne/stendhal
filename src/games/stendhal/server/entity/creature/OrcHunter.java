...
public class OrcHunter extends Creature
  {
  /** the logger instance. */
  private static final Logger logger = Log4J.getLogger(OrcHunter.class);
  ...
  public OrcHunter() throws AttributeNotFoundException
    {
    super();
    put("class","crchunter");
    put("x",0);
    ...
    logger.debug("Created OrcHunter: "+this);
    }

 ...
 * @author hendrik
 */
public class SimpleQuestCompleteBuilder extends QuestCompleteBuilder {
	...
	public SimpleQuestCompleteBuilder respondToReject(String respondToReject) {
		this.respondToReject = respondToReject;
		return this;
	}

	public SimpleQuestCompleteBuilder respondToAccept(String respondToAccept) {
		this.respondToAccept = respondToAccept;
		return this;
	}

	public SimpleQuestCompleteBuilder rewardWith(ChatAction action) {

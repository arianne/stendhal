...
public class PassiveEntityRespawnPointFactory {
	 ...
	 */
	public static PassiveEntityRespawnPoint create(String clazz, int type, ID id, int x, int y) {
		PassiveEntityRespawnPoint passiveEntityrespawnPoint = null;

		if (clazz.contains("herb")) {
			switch (type) {
			case 0:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("arandula", 400);
				break;
			case 1:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("kekik", 800);
				break;
			case 2:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("sclaria", 800);
				break;
			}
			...
			switch (type) {
			case 0:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("button_mushroom", 500);
				break;
			case 1:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("porcini", 1000);
				break;
			case 2:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("toadstool", 1000);
				break;
			}
		} else if (clazz.contains("resources")) {
			switch (type) {
			case 0:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("wood", 1500);
				break;
			case 1:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("iron_ore", 3000);
			...
			switch (type) {
			case 0:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("apple",
						500);
				break;
			case 1:
				...
				break;
			case 2:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("salad", 1500);
				break;
			case 3:
			...
			case 4:
				...
				break;
			case 5:
				passiveEntityrespawnPoint = new VegetableGrower("chinese_cabbage");
				break;
			case 6:
			...
			case 8:
				...
				break;
			case 9:
				passiveEntityrespawnPoint = new PassiveEntityRespawnPoint("spinach", 1500);
				break;
			case 10:

 ...
 *
 */
public class LifeDrainArea extends PassiveEntity implements MovementListener, TurnListener {
	 ...
	 *				(0.0 - 1.0).
	 */
	public LifeDrainArea(String name, int width, int height, int damage, int interval, double probability) throws AttributeNotFoundException {
		put("name", name);

...
public enum ZoneEventType {
	...
	VISIT_IMPERIAL_CAVES ("Commands and orders are heard from afar. You can only imagine you must be approaching an army of some sort. Worryingly, you can also hear some very very heavy footsteps."),
	VISIT_MAGIC_CITY_N ("Your skin prickles as you explore further. There is definitely magic here."),
	VISIT_MAGIC_CITY ("You now sense a strong magical presence. Perhaps sorcerors are nearby, or some strong enchantments?"),
	VISIT_DREAMSCAPE ("You start to hallucinate. You think you're in a new land, somewhere unknown, with strange, terrible creatures and fantastic sights."),
	VISIT_SEMOS_CAVES ("The ground in this cave trembles from the footfalls of GIANTS! The weak should explore no further here. Turn around and run away!"),
	VISIT_ADOS_CASTLE ("You sense that great atrocities have happened here. The castle must be overrun with evil creatures, as the sounds of their last victims ring in your ears. It may be wise to stay away.");

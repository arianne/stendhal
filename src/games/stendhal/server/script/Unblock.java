...
public class Unblock extends ScriptImpl implements TurnListener {
	...
	static class KeepFreeArea {
		 ...
		 */
		public KeepFreeArea(StendhalRPZone zone, Area area, int x, int y) {
			super();
			this.area = area;
			this.x = x;
			this.y = y;
	...
	public void execute(Player admin, List<String> args) {
		...
		rect.setRect(17, 23, 3, 2);
		keepFreeAreas.add(new KeepFreeArea(world.getZone("0_semos_city"), new Area(world.getZone("0_semos_city"), rect), 23, 25));

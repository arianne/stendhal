...
            quantity = 0; // quantity == 0 performs a regular move of the entire item
...
            StackableItem newItem=(StackableItem)((StendhalRPWorld) world).getRuleManager().getEntityManager().getItem(entity.get("name"));

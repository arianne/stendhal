...
public class PathfinderTest {
	...
	public static void main(String[] args) throws Exception {
		...
		List<String> tests = Arrays.asList("rat;50;10;rat;55;3", "rat;55;3;rat;50;10", "rat;50;12;rat;52;15",
		        ...
		        "bat;52;14;rat;50;12", "rat;50;10;bat;55;2", "rat;55;3;bat;50;9", "rat;50;12;bat;52;14",
		        "rat;52;15;bat;50;11", "giantrat;55;3;bat;50;9", "giantrat;52;15;bat;50;11", "bat;55;2;bat;50;9",
		        "bat;52;14;bat;50;11");
		...
		for (String test : tests) {
			...
			System.out.print("\tentityArea: (" + entityArea.getX() + ", " + entityArea.getY() + ", "
			        + entityArea.getWidth() + ", " + entityArea.getHeight() + ")");
			System.out.print(" targetArea: (" + targetArea.getX() + ", " + targetArea.getY() + ", "
			        + targetArea.getWidth() + ", " + targetArea.getHeight() + ")");
			System.out.println(" destArea: (" + destArea.getX() + ", " + destArea.getY() + ", " + destArea.getWidth()
			        + ", " + destArea.getHeight() + ")");

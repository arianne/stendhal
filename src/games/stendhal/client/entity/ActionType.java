...
public enum ActionType {
	LOOK("look", "Look"), READ("look", "Read"), INSPECT("inspect", "Inspect"), ATTACK("attack", "Attack"), STOP_ATTACK(
	        "stop", "Stop attack"), CLOSE("use", "Close"), OPEN("use", "Open"), OWN("own", "Own"), USE("use", "Use"), HARVEST(
	        "use", "Harvest"), PICK("use", "Pick"), PROSPECT("use", "Prospect"), LEAVE_SHEEP("own", "Leave sheep"), ADD_BUDDY(
	        "addbuddy", "Add to Buddies"), ADMIN_INSPECT("inspect", "(*)Inspect"), ADMIN_DESTROY("destroy",
	        "(*)Destroy"), ADMIN_ALTER("alter", "(*)Alter"), DEBUG_SHOW_PATH("[show path]", "ShowPath"), DEBUG_HIDE_PATH(
	        "[hide path]", "HidePath"), DEBUG_ENABLE_WATCH("[enable watch]", "Enable Watch"), DEBUG_DISABLE_WATCH(
	        "[disable watch]", "Disable Watch"), SET_OUTFIT("outfit", "Set outfit");

...
// rightPanel.setPreferredSize(new Dimension(BORDER_WIDTH, SCREEN_HEIGHT));
        ...
        propertyMgr.setDefaultProperties("Buddies", false, BORDER_WIDTH + SCREEN_WIDTH, 300);
        propertyMgr.setDefaultProperties("Character", false, BORDER_WIDTH + SCREEN_WIDTH, 0);
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_DOWN:
                ...
                if (e.isAltGraphDown()) {
                    ...
                    EntityView view = screen.getEntityViewAt(user.getX() + direction.getdx(), user.getY()
                            + direction.getdy());
    ...
    public void requestQuit() {
        if (JOptionPane.showConfirmDialog(desktop, "Are you sure you want to leave Stendhal?", "Stendhal",

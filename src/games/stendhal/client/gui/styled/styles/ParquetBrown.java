 ...
 * The style.
 */
public class ParquetBrown implements Style {
	private static final int DEFAULT_FONT_SIZE = 12;
	
	private static final Color highLightColor = new Color(90, 38, 0); // Brown
	private static final Color shadowColor = new Color(225, 173, 110); // Light brown
	...
	public ParquetBrown() {
		...
		background = st.getSprite("data/gui/panel_parquet_brown_001.png");
	...
	public static synchronized Style getInstance() {
		if (sharedInstance == null) {
			sharedInstance = new ParquetBrown();
		}

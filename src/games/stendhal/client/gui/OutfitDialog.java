...
public class OutfitDialog extends JDialog {
	...
	private static final int CLOTHES_OUTFIT = 51;

	private static final int HAIR_OUTFITS = 41;
	...
	/** Bodies Left button.
	 * @param evt */
	private void jbtLeftBodiesActionPerformed(ActionEvent evt) {
		if (bodies_index > 0) {
			bodies_index--;
		} else {
	...
	/** Heads Right button.
	 * @param evt */
	private void jbtRightHeadsActionPerformed(ActionEvent evt) {
	...
	/** Heads Left button.
	 * @param evt */
	private void jbtLeftHeadsActionPerformed(ActionEvent evt) {
		if (heads_index > 0) {
			heads_index--;
		} else {
	...
	/** Hairs Right button.
	 * @param evt */
	private void jbtRightHairsActionPerformed(ActionEvent evt) {
	...
	/** Hairs Left button.
	 * @param evt */
	private void jbtLeftHairsActionPerformed(ActionEvent evt) {
		if (hairs_index > 0) {
			hairs_index--;
		} else {

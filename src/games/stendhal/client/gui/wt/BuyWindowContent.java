...
public class BuyWindowContent extends javax.swing.JPanel {
	...
	nextButton = new StyledJButton(style);
        ...
        npc_chooser.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
        ...
        jLabel1.setText("<html>Select a food or drink item from the <br>list and click 'Next'.");
        ...
        xinSell.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
        ...
        xinBuy.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
        ...
        jLabel4.setText("<html>Please choose an<br>item from <u><b>one</u></b><br>of the lists before<br>continuing.");
        ...
        jLabel6.setText("Please choose the amount of items you wish to buy or sell.");
    ...
    private void npc_chooserValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_npc_chooserValueChanged

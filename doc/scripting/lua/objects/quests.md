...
- Returns: New {@link games.stendhal.server.core.scripting.lua.QuestHelper#LuaQuest} instance.
...
- Parameters:
  - ***quest:*** The {@link games.stendhal.server.maps.quests.IQuest} instance to be loaded.
...
- Parameters:
  - ***quest:*** {@link games.stendhal.server.maps.quests.IQuest} instance to be loaded.
- Aliases:
...
- Parameters:
  - ***quest:*** {@link games.stendhal.server.maps.quests.IQuest} instance to check.
...
- Dumps the internal quest states for the specified player. This is used for the {@link games.stendhal.server.action.admin.InspectAction}.
- Parameters:
  - ***player:*** Player to create the report for.
- Returns: String report.
...
- Retrieves the {@link games.stendhal.server.maps.quests.IQuest} object for a named quest.
- Parameters:
...
- Retrieves the {@link games.stendhal.server.maps.quests.IQuest} object for a quest.
- Parameters:
...
- Parameters:
  - ***player:*** {@link games.stendhal.server.entity.player.Player} instance to be checked.

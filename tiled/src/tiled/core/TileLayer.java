...
public class TileLayer extends MapLayer
{
  ...
  public void setTileAt(int tx, int ty, Tile ti)
  {
    if (canEdit() && contains(tx, ty))
    {
      ...
      // TODO: find a better way. Not very good to notify every single tile change
  ...
  /**
   * Copy data from another layer onto this layer. Unlike mergeOnto, copyFrom()
   * copies the empty cells as well.
   * 

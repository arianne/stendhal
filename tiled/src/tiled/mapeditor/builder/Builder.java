 ...
 * through a builder.
 * Builders are based on brushes. How they interpret these brushes is their 
 * problem.
 * 
 * The builder is called each time a mouse click or draw occures on the map.
 * It can then simply place the the current brush on the map or do something
 * more sophisticated (like drawing streets/corridors/forests/houses).
 * 
 * @author mtotz
 */

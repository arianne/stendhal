...
public class MapLayerEdit extends AbstractUndoableEdit
{
   ...
   * @param map the map
   * @param before the layers which will be modified. This is the state wich 
   *               will be restored upon undo.
   */
   ...
   * @param before the layers which will be modified. This is the state wich 
   *               will be restored upon undo.
   * @param after the layers after they are modified. The order of the layer 
  ...
  /**
   * Sets the start state of the layers. The layer list will be copied, so
   * you don't have to do it yourself.
   * 
   * @param layers the layers which will be modified
   */
  ...
  public void end(List<MapLayer> layers)
  {
    ...
    if (layerReference.size() != layers.size())
    {
      throw new IllegalArgumentException(
          "size of end-layers list must be the same as the start layers list "+

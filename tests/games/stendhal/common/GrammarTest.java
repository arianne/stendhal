...
public class GrammarTest {
	...
	public void testPluralItem() {
		...
		Assert.assertEquals("katanas", Grammar.plural("katana")); // wikipedia says katana/katanas ok
		...
		Assert.assertEquals("twoside axes +3", Grammar.plural("twoside axe +3")); // i will make a set of names for these +s
		...
		Assert.assertEquals("suits of leather armor", Grammar.plural("suit of leather armor")); //
		Assert.assertEquals("leather cuirasses", Grammar.plural("leather cuirass"));
		Assert.assertEquals("suits of leather armor +1", Grammar.plural("suit of leather armor +1")); //
		Assert.assertEquals("leather cuirasses +1", Grammar.plural("leather cuirass +1"));
		Assert.assertEquals("suits of studded armor", Grammar.plural("suit of studded armor")); //
		Assert.assertEquals("suits of chain armor", Grammar.plural("suit of chain armor")); //
		...
		Assert.assertEquals("suits of golden armor", Grammar.plural("suit of golden armor")); //
		...
		Assert.assertEquals("chain helmets +2", Grammar.plural("chain helmet +2"));
		Assert.assertEquals("golden helmets", Grammar.plural("golden helmet"));
		Assert.assertEquals("golden helmets +3", Grammar.plural("golden helmet +3"));
		Assert.assertEquals("trophy helmets", Grammar.plural("trophy helmet"));
		Assert.assertEquals("pairs of leather legs", Grammar.plural("pair of leather legs")); //
		Assert.assertEquals("pairs of studded legs", Grammar.plural("pair of studded legs")); //
		Assert.assertEquals("pairs of chain legs", Grammar.plural("pair of chain legs")); //
		Assert.assertEquals("pairs of golden legs", Grammar.plural("pair of golden legs")); //
		Assert.assertEquals("pairs of leather boots", Grammar.plural("pair of leather boots")); //
		Assert.assertEquals("pairs of studded boots", Grammar.plural("pair of studded boots")); //
		Assert.assertEquals("pairs of chain boots", Grammar.plural("pair of chain boots")); //
		Assert.assertEquals("pairs of steel boots", Grammar.plural("pair of steel boots")); //
		Assert.assertEquals("pairs of golden boots", Grammar.plural("pair of golden boots")); //
		...
		Assert.assertEquals("green dragon cloaks", Grammar.plural("green dragon cloak"));
		Assert.assertEquals("lich cloaks", Grammar.plural("lich cloak"));
		Assert.assertEquals("blue dragon cloaks", Grammar.plural("blue dragon cloak"));
		Assert.assertEquals("black dragon cloaks", Grammar.plural("black dragon cloak"));
		Assert.assertEquals("golden cloaks", Grammar.plural("golden cloak"));
		Assert.assertEquals("cherries", Grammar.plural("cherry"));
		Assert.assertEquals("pieces of cheese", Grammar.plural("piece of cheese")); //
		...
		Assert.assertEquals("button mushrooms", Grammar.plural("button mushroom"));
		...
		//		Assert.assertEquals("greater poisons", Grammar.plural("greater poison"));
		//		Assert.assertEquals("deadly poisons", Grammar.plural("deadly poison"));
		...
		Assert.assertEquals("money", Grammar.plural("money")); // See my bug report! don't like this!
		...
		Assert.assertEquals("sheaves of grain", Grammar.plural("sheaf of grain"));
	...
	public void testPluralCreatures() {
		...
		Assert.assertEquals("green slimes", Grammar.plural("green slime")); //plural of slime is slime but this is a creature....
		...
		Assert.assertEquals("brown slimes", Grammar.plural("brown slime")); //plural of slime is slime but this is a creature....
		...
		Assert.assertEquals("orc chiefs", Grammar.plural("orc chief")); //chief is an exception to the v rule
		...
		Assert.assertEquals("warrior skeletons", Grammar.plural("warrior skeleton"));
		Assert.assertEquals("black slimes", Grammar.plural("black slime")); //plural of slime is slime but this is a creature....
		...
		Assert.assertEquals("elf sacerdotists", Grammar.plural("elf sacerdotist"));
		Assert.assertEquals("earth elementals", Grammar.plural("earth elemental"));
		Assert.assertEquals("fire elementals", Grammar.plural("fire elemental"));
		Assert.assertEquals("water elementals", Grammar.plural("water elemental"));

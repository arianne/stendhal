...
Rectangle area;
		...
		area = new Rectangle(4,5,1,1);		assertEquals(Direction.LEFT, ae.getDirectionToward(area));
	//	ae.faceto(5,5);		assertEquals(Direction.DOWN, ae.getDirection());
		area = new Rectangle(6,5,1,1);		assertEquals(Direction.RIGHT, ae.getDirectionToward(area));

		area = new Rectangle(4,6,1,1);		assertEquals(Direction.DOWN, ae.getDirectionToward(area));
		area = new Rectangle(5,6,1,1);		assertEquals(Direction.DOWN,ae.getDirectionToward(area));
		area = new Rectangle(6,6,1,1);		assertEquals(Direction.DOWN,ae.getDirectionToward(area));
	}

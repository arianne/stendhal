...
public class LevelGreaterThanConditionTest {
	...
	public final void testHashCode() {
		assertEquals(new LevelGreaterThanCondition(101).hashCode(),new LevelGreaterThanCondition(101).hashCode());
	...
	public final void testEqualsObject() {
		assertEquals(new LevelGreaterThanCondition(101),new LevelGreaterThanCondition(101));
		assertFalse((new LevelGreaterThanCondition(101)).equals(new LevelGreaterThanCondition(102)));
		assertFalse((new LevelGreaterThanCondition(102)).equals(new LevelGreaterThanCondition(101)));

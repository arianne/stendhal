...
public class KilledConditionTest {
	...
	public final void testHashCode() {
		...
		assertEquals(new KilledCondition("rat").hashCode(), new KilledCondition("rat").hashCode());
		assertEquals("i would expect this equal",new KilledCondition("rat","mouse").hashCode(), new KilledCondition("mouse","rat").hashCode());
	...
	public final void testEqualsObject() {
		...
		assertEquals("i would expect this equal",new KilledCondition("rat","mouse"), new KilledCondition("mouse","rat"));
	}

...
public class IntroducePlayersTest {
	...
	public void testHiAndbye() {
		...
		assertEquals("Ssshh! Come here, null! I have a #task for you.", npc.get("text"));
		en.step(player, "task" );
		assertTrue(npc.isTalking());
	    assertEquals("I'm not feeling well... I need to get a bottle of medicine made. Can you fetch me an empty #flask?", npc.get("text"));
		en.step(player, "flask");
		assertTrue(npc.isTalking());
		assertEquals("You could probably get a flask from #Margaret.", npc.get("text"));
		en.step(player, "bye");
	...
	public void testQuest() {
		...
		assertEquals("Ssshh! Come here, null! I have a #task for you.", tad.get("text"));
		engineTad.step(player, "task" );
		assertTrue(tad.isTalking());
	    assertEquals("I'm not feeling well... I need to get a bottle of medicine made. Can you fetch me an empty #flask?", tad.get("text"));
		...
		engineTad.step(player, "hi");
		assertTrue(tad.isTalking());
		assertEquals("Ok, you got the flask! Now, I need you to take it to #ilisa... she'll know what to do next.", tad.get("text"));
		assertTrue(player.hasQuest("introduce_players"));
		...
		assertEquals("Ah, I see you have that flask. #Tad needs medicine, right? Hmm... I'll need a few #herbs. Can you help?", ilisa.get("text"));
		...
		assertEquals("Tad has already asked and the quest was accepted","*sniff* *sniff* I still feel ill, please hurry",tad.get("text"));

...
public class MeetIoTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testHistory() {
		...
		assertThat(quest.getHistory(player), contains("I met the telepath Io Flotto in Semos Temple.",
				"Io taught me the six basic elements of telepathy and promised to remind me if I need to refresh my knowledge."));
	}
	...
	public void testQuestComplition() {
		...
		en.step(player, "Yes");
		assertThat(getReply(npc), is(
				"*yawns* Maybe I'll show you later... I don't want to overload you with too much information at once. You can get a summary of all those lessons at any time, incidentally, just by typing #/help.\nRemember, don't let anything disturb your concentration."));
		assertThat(en.getCurrentState(), is(ConversationStates.IDLE));

...
public class KillSpidersTest {
	...
	public void testQuest() {
		...
		en = npc.getEngine();
		en.step(player, "hi");
		assertEquals("Hello my friend. Nice day for walking isn't it?", npc.get("text"));
		en.step(player, "yes");
		assertEquals("Fine fine, I hope you enjoy your day.", npc.get("text"));
		en.step(player, "task");
		...
		en.step(player, "hi");
		assertEquals("Go down and kill the creatures, no time left.", npc.get("text"));
		en.step(player, "bye");
		assertEquals("Bye.", npc.get("text"));
		...
		assertEquals("Oh thank you my friend. Here you have something special, I got it from a Magican. Who he was I do not know. What the egg's good for, I do not know. I only know, it could be useful for you.", npc.get("text"));
		...
		assertEquals("Hello my friend. Nice day for walking isn't it?", npc.get("text"));
		en.step(player, "task");
		assertEquals("Sorry there is nothing to do for you yet. But maybe you could come back later. I have to clean the school once a week.", npc.get("text"));
		en.step(player, "bye");
		assertEquals("Bye.", npc.get("text"));

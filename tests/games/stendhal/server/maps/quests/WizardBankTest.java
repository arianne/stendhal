...
public class WizardBankTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testHiAndBye() {
		...
		assertEquals("Semos, Nalwor, Fado and Magic City bank chests are to my right. The chests owned by Kirdneh, Deniran and Ados Bank Merchants and your friend Zara are to my left. If you are finished before your time here is done, please say #leave.", getReply(npc));
	}

...
import static games.stendhal.server.core.rp.achievement.factory.ItemAchievementFactory.ID_MAGIC;
...
public class MagicSuppliesAchievementTest {
	...
	private void testAchievement() {
		final int itemCount = ITEMS_MAGIC.length;
		int idx = 0;
	...
	private boolean achievementReached() {
		return AchievementTestHelper.achievementReached(player, ID_MAGIC);
	}
}

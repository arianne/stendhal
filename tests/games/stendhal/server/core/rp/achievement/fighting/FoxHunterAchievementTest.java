...
import static games.stendhal.server.core.rp.achievement.factory.FightingAchievementFactory.ID_FOXES;
...
public class FoxHunterAchievementTest extends ZoneAndPlayerTestImpl {
	...
	private boolean achievementReached() {
		return AchievementTestHelper.achievementReached(player, ID_FOXES);
	}
}

...
import static games.stendhal.server.core.rp.achievement.factory.FightingAchievementFactory.ID_TEAM_PLAYER;
...
public class TeamPlayerAchievementTest extends ZoneAndPlayerTestImpl {
	...
	private boolean achievementReached() {
		return AchievementTestHelper.achievementReached(player, ID_TEAM_PLAYER);
	}
}

...
public class BluffyTheSlayerTest {

	private static final AchievementNotifier notifier = SingletonRepository.getAchievementNotifier();
	private Player player;

	// ID used for achievement
	private final String achievementId = FightingAchievementFactory.ID_BLUFFY;

	// list of enemies
	private final List<String> requiredKills = Arrays.asList(FightingAchievementFactory.ENEMIES_BLUFFY);

	// required number of kills for each enemy
	private final int KILL_COUNT = FightingAchievementFactory.COUNT_BLUFFY;
